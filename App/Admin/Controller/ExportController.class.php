...
class ExportController extends BaseController
{
    ...
    function __construct()
    {
        ...
        require_once 'Public/PHPExcel_1.8.0_doc/Classes/PHPExcel.php';
        require_once 'Public/PHPExcel_1.8.0_doc/Classes/PHPExcel/IOFactory.php';
        require_once 'Public/PHPExcel_1.8.0_doc/Classes/PHPExcel/Writer/Excel2007.php';
        require_once 'Public/PHPExcel_1.8.0_doc/Classes/PHPExcel/Reader/Excel2007.php';
    }
    ...
    private function output($data)
    {
        ...
        for ($i = 0; $i < $num; $i ++) {
            ...
            // 写到文件temp.png之中
            if (! is_null($data[$i]->chemical_structure)) {
                echo ("is not null");
                $file = fopen("E:/1.txt", "a+");
                fwrite($file, "is not null\n");
                fclose($file);
                $fh = fopen("Public/pic/pic_$i.png", "w");
                ...
                $objDrawing->setPath("Public/pic/pic_$i.png");
            ...
            $PHPExcel->getActiveSheet()->setCellValue('Q' . $j, $data[$i]->solubleness);

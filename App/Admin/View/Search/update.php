...
?>
			<div class="right-side">
				<form action="__ROOT__/index.php/Admin/chemical/update?id=<?php echo($detail->id)?>" enctype="multipart/form-data"
					method="post">
					...
					<div class="info-i" id="reference">
						...
						<div style="margin-top: 60px; padding-left: 40%;">
							...
							<button type="button" class="btn btn-danger"
								onclick="window.location.href='__ROOT__/index.php/Admin/chemical/index'">&nbsp;取消&nbsp;</button>
						</div>
					</div>
				</form>
			</div>

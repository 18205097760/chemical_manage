				...
				<div class="row">
					...
					<div class="col-xs-2 col-sm-2 col-md-2" style="float: right">
						<button class="btn btn-primary" style="margin-top: 15px;"
							onclick="window.location.href='/chemical_manage/index.php/Admin'">管理员登录</button>
	...
	<div class="container">
		...
		<div id="forms_container"
			...
			<form action="/chemical_manage/index.php/Home/login" method="post">
                ...
                <?php
 if ($_SESSION['loginError']) { echo ("<p style=\"color: RED\">用户名或密码错误</p>"); } ?>
                <input type="text" class="form-control" id="name"
					name="name" placeholder="用户ID" style="margin-bottom: 18px" required>
				<input type="password" class="form-control" id="password"
					name="password" placeholder="密码" required> <input type="submit"
					class="fbtn blue" />
			...
			<button id="reg" class="btn-danger fbtn"
				...
				onClick="location.href='/chemical_manage/Public/register.php'">注册新用户</button>
		</div>
		</form>
		<div id="video" class="col-sm-7">
			<div id="placeholder">
				<img src="/chemical_manage/Public/Bootstrap/imgs/a.gif"
					alt="Nanjing University" style="height: 330px">
			</div>
		</div>
	</div>

...
<html lang="zh-CN">
  <head>
	...
	<!-- Out -->
	<link href="__ROOT__/Bootstrap/css/style.css" rel="stylesheet">
    ...
    <div class="navbar">
    	<div class="container">
            <div class="navbar-header">
                <div class="fb-header-logo-container navbar-brand" style="padding-top:0">
                    <img src="__ROOT__/Bootstrap/imgs/a.png" alt="Nanjing University" style="height:55px">
                </div>
                <!-- 
      ...
      <div class="container">
            ...
            <div id="video" class="col-sm-7">
                <div id="placeholder">
                    <img src="__ROOT__/Bootstrap/imgs/a.gif" alt="Nanjing University" style="height:330px">
                </div>
            </div>
          </div> 

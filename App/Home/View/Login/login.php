 ...
 -->
	...
	<div class="container">
		...
		<div id="forms_container"
			...
			<form action="__ROOT__/index.php/Home/login" method="post">
			...
			<button id="reg" class="btn-danger fbtn"
				...
				onClick="location.href='__ROOT__/Public/register.php'">注册新用户</button>
		</div>
		</form>
		<div id="video" class="col-sm-7">
			<div id="placeholder">
				<img src="__ROOT__/Public/Bootstrap/imgs/a.gif"
